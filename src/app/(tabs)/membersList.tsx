...
import { Member } from '../../types/type';
    ...
    { id: 1, name: 'FRIAS-KLEIN, Luciano', number: '3644719299', status: 'PAGADO', statusColor: '#10B981' },
    { id: 2, name: 'ASSELBORN, LuciA', number: 'null', status: 'VENCIDO', statusColor: '#EF4444' },
    { id: 3, name: 'OBREGON, Delmiro', number: '003', status: 'POR VENCER', statusColor: '#F59E0B' },
    { id: 4, name: 'OBREGON, Delmiro', number: '004', status: 'POR VENCER', statusColor: '#F59E0B' },
    ];
